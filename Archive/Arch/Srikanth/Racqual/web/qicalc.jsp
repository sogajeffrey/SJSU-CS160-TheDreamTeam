...
<html>
   <head>
	...
	<section id="main" class="container small">
	   <header class="row uniform half collapse-at-2">
		<div>
		   <h2>Tennis Racquet Quality Index Calculator</h2>
		   <p>Wondering about what your racquet's quality index is?</p>
		   <p>Use the form below to find out!</p>
		</div>
		<div>
		   <span class='image'><img src='images/qicalc.jpg' alt='qicalc' width='150' height='150' /></span>
		</div>
	   </header>
	   <div class="box">
