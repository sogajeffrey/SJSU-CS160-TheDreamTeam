        ...
        <section id="main" class="container small">
            ...
            <div class="box">
                <form method="post" action="UserUpdateServlet">
                    ...
                    <div class="row uniform half collapse-at-2">
                        <div class="6u">
                            <input id="username" name="username" placeholder="Username" tabindex="2" type="text" value="<% currentUsers.getUserName() %>">
                        </div>
                        <div class="6u">
                            <input type="email" name="email" id="email" value="" placeholder="Email Address" value="<% currentUsers.getEmail() %>">
                        </div>
                    ...
                    <div class="row uniform half collapse-at-2">
                        ...
                        <div class="6u">
                            <input type="password" id="repassword" name="repassword" placeholder="Verify Your Password" >
                        </div>
                    </div>
