...
<section id="main" class="container small">
  ...
  <div class="box">
    <form method="post" action="UserRegistrationServlet">
      ...
      <div class="3u">
        <input type="password" maxlength="2" name="BirthDay"  placeholder="Day" required="">
      </div>
      <div class ="4u">
      <input type="password" maxlength="4" name="BirthYear" placeholder="Year" required="">
      </div>
      </div>
     <div class="row uniform half collapse-at-3">
     <div class="4u">
      ...
      <div class ="4u">
      <input type="password" name="city" placeholder="City" required="">
      </div>
      <div class ="4u">
      <input type="password" name="state" placeholder="State" required="">
      </div>
	</div>
